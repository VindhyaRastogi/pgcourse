...
const Banner = () => {
  ...
  return (
    <div className="mt-4 w-full transition-colors py-2 bg-teal-500 flex items-center justify-center text-lg font-bold flex-col">
      <p className={isRed ? "text-red-600 mx-16" : "text-white mx-16"}>
