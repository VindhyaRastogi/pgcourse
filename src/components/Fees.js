            ...
            <div className="relative flex flex-col items-center justify-center w-screen">
                <div className="absolute mx-20 z-10 bg-gray-900 bg-opacity-90 justify-center">
                    <ul className="list-disc text-2xl font-bold text-white m-5">
                        <li className="ml-8 my-5 text-base min-[550px]:pr-2 min-[550px]:pl-2 min-[550px]:text-3xl text-sm">Rs. 25000 for one year program (Highly Subsidized only for this year).</li>
                        ...
                        <li className= "ml-8 my-5 text-base min-[550px]:pr-2 min-[550px]:pl-2 min-[550px]:text-3xl text-sm">Last date to submit the fees is 25th August 2024.</li>
                    </ul>
                </div>
