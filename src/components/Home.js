  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen">
      <div className="relative flex flex-col items-center justify-center w-screen">
        <div className="homeHeadingBanner absolute z-10 bg-gray-900 bg-opacity-80 justify-center">
          <h1 className="homeHeadingText1 mx-10 text-2xl font-bold text-white text-center m-10">Post-Graduate Diploma in Data Science in Health and Climate Change for Social Impact</h1>
          <h1 className="homeHeadingText2 mx-10 text-2xl font-bold text-white text-center m-5">Hands-on experience | Internship Opportunities | 36 weeks Hybrid Program</h1>
        </div>
